...
undefined4 run_command(LPSTR param_1, DWORD param_2, LPDWORD param_3) {
	BOOL BVar1;
	DWORD DVar2;
	int iVar3;
	LPSTR *ppCVar4;
...
undefined4 FUN_0040170a(void) {
	...
	if (iVar1 != 0) {
		...
		if (hModule != NULL) {
			_DAT_0040f878 = GetProcAddress(hModule,"CreateFileW");
			_DAT_0040f87c = GetProcAddress(hModule,"WriteFile");
			_DAT_0040f880 = GetProcAddress(hModule,"ReadFile");
			_DAT_0040f884 = GetProcAddress(hModule,"MoveFileW");
			_DAT_0040f888 = GetProcAddress(hModule,"MoveFileExW");
			_DAT_0040f88c = GetProcAddress(hModule,"DeleteFileW");
			_DAT_0040f890 = GetProcAddress(hModule,"CloseHandle");
			if ((((_DAT_0040f878 != NULL) && (_DAT_0040f87c != NULL)) && (_DAT_0040f880 != NULL)) && (((_DAT_0040f884 != NULL && (_DAT_0040f888 != NULL)) && ((_DAT_0040f88c != NULL && (_DAT_0040f890 != NULL)))))) {
				return 1;
			}
		}
	}
...
uint FUN_0040267b(int *param_1,LPVOID *param_2) {
  LPVOID dwSize;
  LPVOID pvVar1;
  uint flNewProtect;
  BOOL BVar2;
...
uint FUN_00402758(int *param_1,int param_2) {
  int iVar1;
  int iVar2;
  int *piVar3;
  uint uVar4;
...
int * FUN_0040432b(int param_1,int param_2,int param_3) {
  int *piVar1;
  int iVar2;
...
int FUN_00404fa0(int *param_1,uint *param_2,int *param_3,int param_4,int param_5) {
  uint *puVar1;
  int iVar2;
  uint local_8;
...
uint FUN_004055a3(uint *param_1,byte param_2) {
  uint uVar1;
...
byte * FUN_0040583c(byte **param_1,byte *param_2) {
  byte bVar1;
  undefined4 *puVar2;
  undefined4 uVar3;
  uint uVar4;
...
int FUN_00405def(char *param_1,uint *param_2) {
  uint uVar1;
  int iVar2;
  byte local_5;
...
void FUN_00405e27(char *param_1,int *param_2) {
  uint uVar1;
  int iVar2;
  uint local_8;
...
void FUN_00405e6b(char *param_1,char **param_2) {
  char *pcVar1;
  char *pcVar2;
  int iVar3;
  int iVar4;
...
undefined4 FUN_00406162(void **param_1) {
  if (param_1 == (void **)0x0) {
	return 0xffffff9a;
  }
...
int FUN_0040657a(char **param_1,char **param_2,char **param_3,int *param_4) {
  char **ppcVar1;
  char **ppcVar2;
  char **ppcVar3;
  int iVar4;
...
undefined4 FUN_0040671d(char **param_1,byte *param_2) {
  char *pcVar1;
  char **ppcVar2;
  undefined uVar3;
  int iVar4;
...
byte * FUN_00406880(void *param_1,void *param_2,void *param_3,undefined *param_4) {
	void **ppvVar1;
	char cVar2;
	void **ppvVar3;
	byte *pbVar4;
	...
	if ((param_1 == (void *)0x0) || (ppvVar3 = *(void ***)((int)param_1 + 0x7c), ppvVar3 == (void **)0x0)) {
	...
	LAB_00406a75:
		...
		if (ppvVar3[5] != (void *)0x0) {
			...
			if ((ppvVar3[2] == (void *)0x0) && (pvVar9 = ppvVar3[0x16], pvVar9 != (void *)0x0)) {
				...
				if ((iVar6 != 0) || (uVar7 = FUN_00405d8a(*ppvVar3,(uint)pvVar8,1,(char *)ppvVar3[0x18]), uVar7 != 1)) {
				...
				do {
					uVar7 = FUN_004055a3((uint *)(ppvVar3 + 0x1c),*(byte *)((int)param_1 + (int)pvVar9));
...
ulonglong FUN_00406b02(uint param_1) {
	ulonglong uVar1;

	uVar1 = __allmul(param_1 + 0xb6109100,((int)param_1 >> 0x1f) + 2 + (uint)(0x49ef6eff < param_1), 10000000,0);
	return uVar1;
}
...
char ** __thiscall FUN_00406b8e(void *this,LPCSTR param_1,undefined4 param_2,int param_3) {
	...
	if ((*(int *)this == 0) && (*(int *)((int)this + 4) == -1)) {
		...
		if ((param_3 == 1) && (DVar3 = SetFilePointer(param_1, 0, NULL, 1), DVar3 == 0xffffffff)) {
			...
			if (uVar6 == local_10) {
				*param_2 = *(undefined4 *)(*(int *)this + 0x10);
				...
				while( true ) {
					...
					if ((puVar7 == (uchar *)0x0) &&	(((puVar7 = _mbsstr(_Str,(uchar *)&_Substr_0040f830), puVar7 == (uchar *)0x0 &&	(puVar7 = _mbsstr(_Str,(uchar *)&_Substr_0040f828), puVar7 == (uchar *)0x0)) && (puVar7 = _mbsstr(_Str,(uchar *)&_Substr_0040f820), puVar7 == (uchar *)0x0))))
						break;
					_Str = puVar7 + 4;
				}
				...
				if ((((local_7c[0] == 0) || (local_7c[0] == 7)) || (local_7c[0] == 0xb)) || (local_7c[0] == 0xe)) {
					bVar9 = (byte)local_48;
				...
				if (4 < local_10) {
					do {
						local_c = (void *)((uint)local_c & 0xff000000 | (uint)CONCAT11(*(undefined *)((int)pvVar3 + iVar5 + 1),*(undefined *)(iVar5 + (int)pvVar3)));
						...
						if (iVar8 == 0) {
							...
							if ((bVar9 & 1) != 0) {
								...
								iVar8 = iVar5 + 9;
								uVar11 = FUN_00406b02(CONCAT31(CONCAT21(*(undefined2 *)(puVar1 + 2),*(undefined *)(iVar5 + 6 + (int)pvVar3)),*puVar1));
							...
							if ((bVar9 >> 1 & 1) != 0) {
								...
								puVar1 = (undefined *)(iVar8 + (int)pvVar3);
								iVar8 = iVar8 + 4;
								uVar11 = FUN_00406b02(CONCAT31(CONCAT21(*(undefined2 *)(puVar1 + 2),*(undefined *)(iVar5 + (int)pvVar3)),*puVar1));
								param_2[0x43] = (int)uVar11;
								param_2[0x44] = (int)(uVar11 >> 0x20);
							}

							if (local_5 != 0) {
								uVar11 = FUN_00406b02(CONCAT31(CONCAT21(*(undefined2 *)((undefined *)(iVar8 + (int)pvVar3) + 2),*(undefined *)(iVar8 + 1 + (int)pvVar3)),*(undefined *)(iVar8 + (int)pvVar3)));
...
void FUN_00407070(LPCSTR param_1,char *param_2) {
	...
	if (cVar1 != '\0') {
		...
		if (DVar2 == 0xffffffff) {
			CreateDirectoryA(local_108,NULL);
		}
	}
	return;
}
...
int __thiscall FUN_00407136(void *this,char *param_1,char *param_2,void *param_3,int param_4) {
	...
	if (param_4 == 3) {
		...
		nNumberOfBytesToWrite = FUN_00406880(*(void **)this,param_2,param_3,(undefined *)((int)&param_1 + 3));
	...
	*(undefined4 *)((int)this + 4) = 0xffffffff;
	...
	if (pcVar7 == pcVar3) {
		local_10c[0] = '\0';
		LAB_004072e1:
		wsprintfA(local_33c,"%s%s%s",(LPCSTR)((int)this + 0x140),local_10c,pcVar7);
		FUN_00407070((LPCSTR)((int)this + 0x140),local_10c);
	} else {
		local_10c[(int)(pcVar7 + -(int)pcVar3)] = '\0';
		
		if (((local_10c[0] != '/') && (local_10c[0] != '\\')) && ((local_10c[0] == '\0' || (local_10c[1] != ':')))) goto LAB_004072e1;
		wsprintfA(local_33c,(LPCSTR)&param_2_0040f840,local_10c,pcVar7);
		FUN_00407070(NULL,local_10c);
	}
		
	pcVar3 = (char *)CreateFileA(local_33c,0x40000000,0,NULL,2,local_130, NULL);
	LAB_00407331:
	...
	do {
		nNumberOfBytesToWrite = FUN_00406880(*(void **)this,*(void **)((int)this + 0x13c),(void *)0x4000, (undefined *)((int)&param_2 + 3));
		...
		if ((0 < (int)nNumberOfBytesToWrite) && (BVar5 = WriteFile(param_1,*(LPCVOID *)((int)this + 0x13c),(DWORD)nNumberOfBytesToWrite, &local_8,(LPOVERLAPPED)0x0), BVar5 == 0)) {
			param_3 = (void *)0x400;
			goto LAB_0040745a;
		}
...
void FUN_004075c4(int *param_1,char *param_2,undefined4 *param_3) {
	*param_3 = 0;
...
void FUN_00407603(int *param_1,char *param_2,char *param_3,void *param_4,int param_5) {
	if (param_1 == (int *)0x0) {
	DAT_0040f938 = 0x10000;
	} else {
		if (*param_1 == 1) {
...
void FUN_0040763d(int *param_1,char *param_2,char *param_3) {
...
uint _controlfp(uint _NewValue,uint _Mask) {
	uint uVar1;
